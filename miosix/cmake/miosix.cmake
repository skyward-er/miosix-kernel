...
# Creates the Miosix::Boot::${BOARD} and Miosix::Kernel::${BOARD} libraries
function(add_miosix_libraries BOARD BOARD_OPTIONS_FILE)
    # Get board specific variables
    ...
    add_library(Miosix::Boot::${BOARD} ALIAS ${BOOT_LIB})
    add_library(Miosix::Kernel::${BOARD} ALIAS ${KERNEL_LIB})
endfunction()
