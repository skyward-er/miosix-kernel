...
elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_anakin)
    set(ARCH cortexM4_stm32f4)
elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v1)
    set(ARCH cortexM4_stm32f4)
elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v2)
    set(ARCH cortexM4_stm32f4)
elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v3)
    set(ARCH cortexM4_stm32f4)
elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_groundstation_nokia)
    set(ARCH cortexM4_stm32f4)
...
elseif(${ARCH} STREQUAL cortexM4_atsam4l)
    ...
    set(AFLAGS_BASE -mcpu=cortex-m3 -mthumb)
    list(APPEND CFLAGS_BASE -D_ARCH_CORTEXM4_ATSAM4L ${CLOCK_FREQ} -mcpu=cortex-m3 -mthumb ${OPT_OPTIMIZATION} -c)
    list(APPEND CXXFLAGS_BASE -D_ARCH_CORTEXM4_ATSAM4L ${CLOCK_FREQ} -mcpu=cortex-m3 -mthumb ${OPT_EXCEPT} ${OPT_OPTIMIZATION} -c)
    set(LFLAGS_BASE -mcpu=cortex-m3 -mthumb -Wl,--gc-sections,-Map,main.map -Wl,-T${LINKER_SCRIPT} ${OPT_EXCEPT} ${OPT_OPTIMIZATION} -nostdlib)
...
elseif(${ARCH} STREQUAL cortexM4_stm32f4)
    ...
    ##-------------------------------------------------------------------------
    ## BOARD: stm32f429zi_skyward_death_stack_v1
    ##
    elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v1)

        ## Base directory with header files for this board
        set(BOARD_INC arch/cortexM4_stm32f4/stm32f429zi_skyward_death_stack_v1)
        ...
        ## Add a #define to allow querying board name
        list(APPEND CFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V1)
        list(APPEND CXXFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V1)
    ...
    ##-------------------------------------------------------------------------
    ## BOARD: stm32f429zi_skyward_death_stack_v2
    ##
    elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v2)

        ## Base directory with header files for this board
        set(BOARD_INC arch/cortexM4_stm32f4/stm32f429zi_skyward_death_stack_v2)
        ...
        ## Add a #define to allow querying board name
        list(APPEND CFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V2)
        list(APPEND CXXFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V2)
    ...
    elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_death_stack_v3)
        ...
        ## Add a #define to allow querying board name
        list(APPEND CFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V3)
        list(APPEND CXXFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_DEATHSTACK_V3)
    ...
    ##-------------------------------------------------------------------------
    ## BOARD: stm32f429zi_skyward_groundstation_nokia
    ##
    elseif(${OPT_BOARD} STREQUAL stm32f429zi_skyward_groundstation_nokia)

        ## Base directory with header files for this board
        set(BOARD_INC arch/cortexM4_stm32f4/stm32f429zi_skyward_groundstation_nokia)
        ...
        ## Add a #define to allow querying board name
        list(APPEND CFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_GROUNDSTATION_NOKIA)
        list(APPEND CXXFLAGS_BASE -D_BOARD_STM32F429ZI_SKYWARD_GROUNDSTATION_NOKIA)
...
elseif(${ARCH} STREQUAL cortexM7_stm32f7)
    ...
    ##-------------------------------------------------------------------------
    ## BOARD: stm32f767zi_compute_unit
    ##
    elseif(${OPT_BOARD} STREQUAL stm32f767zi_compute_unit)
        ## Select appropriate compiler flags for both ASM/C/C++/linker
        ## Not all stm32f7 have the double precision FPU. Those that only
        ...
        ## Base directory with header files for this board
        set(BOARD_INC arch/cortexM7_stm32f7/stm32f767zi_compute_unit)
