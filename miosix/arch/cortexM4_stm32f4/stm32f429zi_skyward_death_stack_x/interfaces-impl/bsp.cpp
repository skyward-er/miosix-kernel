...
void IRQbspInit()
{
    ...
    nosecone::thCut1::csens::mode(Mode::INPUT_ANALOG);

    nosecone::thCut2::ena::mode(Mode::OUTPUT);
    nosecone::thCut2::ena::low();
...
void bspInit2()
{
    ...
    devFs->addDevice("gps", intrusive_ref_ptr<Device>(new STM32Serial(2, 9600)));
